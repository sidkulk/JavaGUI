...
public class UserPasswordDataAccessOperation {
	...
	public static void createPasswordTab() throws Exception {
		...
		String raw = "CREATE TABLE IF NOT EXISTS %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s VARCHAR(100), %s VARCHAR(100), %s INTEGER NOT NULL, FOREIGN KEY (%s) REFERENCES User(%s));";
