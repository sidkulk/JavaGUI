...
public class RegisterPageFXMLController {
	...
	public void registerUser(ActionEvent event) throws IOException, Exception {
		...
		if (areFieldsEmpty) {
			...
			childhoodFrnd = childhoodFrndName.getText();

			int isSuccessful = DatabaseOperations.saveToDatabase(username, password, nickname, childhoodFrnd);
			...
			AlertBoxClass.Notify("SUCCESS",
					"Welcome " + userNameTxtField.getText() + " You'll be directed to Login Page");
